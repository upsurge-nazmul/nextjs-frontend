  ...
  return (
    <div className={styles.privacy}>
      ...
      <p className={styles.details}>
        ...
        <br /> I. Overview
        <br />
        <br /> Upsurge provides a financial learning platform. Upsurge is
        offered via the following plans or service offerings.
        <br />
        <br /> - Basic. For individuals that just need to record and share
        videos quickly, a basic version of Upsurge is available for free when
        you register with Upsurge and set up a user account. <br /> <br /> -
        ...
        <br /> <br /> - Starter Unlimited Videos. A new version of our Basic
        plan (limited availability) which gives users access to Basic features
        plus unlimited videos in their Workspace.
        <br /> <br /> - Pro. For individuals that need advanced recording and
        ...
        of videos.
        <br /> <br /> - Professional. A new version of our Pro plan (limited
        availability). This plan is limited to one Creator and unlimited
        Viewers.
        <br /> <br /> - Business. Includes the premium features of Upsurge
        ...
        as needed.
        <br /> <br />- Enterprise. Includes the premium features of Upsurge
        ...
        <br /> <br /> II. Registration Use of the Service requires that you
        ...
        <br /> <br /> III. Payment If you register for Upsurge Starter
        ...
        <br /> <br /> Any attorney fees, court costs, or other costs incurred in
        collection of delinquent undisputed amounts shall be the responsibility
        of and paid for by you. <br /> <br />
        ...
        communication.
        <br /> <br /> You are responsible for any third-party fees that you may
        incur when using the Service.
        <br /> <br /> IV. Changes to and Your Termination of the Service You
        ...
        <br /> <br />- You, directly or indirectly, alone or with any other
        party, may not: <br /> <br />
        ...
        in the Service or Software; <br /> <br />
        2. distribute, transfer, resell, rent, lease, or loan the Service or
        Software to any other party, except as described herein; <br /> <br />
        ...
        discomfort to a person or entity; <br /> <br />
        ...
        which infringes upon the rights of any third party; <br /> <br />
        ...
        physical harm or injury against any group or individual; <br /> <br />
        ...
        regulations having the force of law; or <br /> <br />
        ...
        reimburse Upsurge for any such penalties, costs or expenses. <br />{" "}
        <br />- You understand that all information (such as data files, written
        ...
        <br /> <br />- While Upsurge uses reasonable efforts to include accurate
        ...
        available on the Site (the “Content”). <br /> <br />- The Site may
        ...
        materials located on such External Sites. <br /> <br />- You acknowledge
        ...
        Content that has been posted by users. <br /> <br />- You retain sole
        ...
        any claims resulting from any of Your Content. <br /> <br />- At your
        ...
        Feedback in any form to any third party without restriction. <br />{" "}
        <br />- The Site may contain areas in which additional terms and
        ...
        this page to review the current Terms to which you are bound. <br />{" "}
        <br />- You shall not transmit to Upsurge or upload to this Site any
        ...
        permission. <br /> <br />- You may not use your username and password
        for any unauthorized purpose. <br /> <br />
        VI. Monitoring and Enforcement; Termination Upsurge has the right to:{" "}
        <br /> <br />- Remove or refuse to post any of Your Content for any or
        no reason at our sole discretion. <br /> <br />- Take any action with
        ...
        Service or the public or could create liability for Upsurge. <br />{" "}
        <br />- Take appropriate legal action, including without limitation,
        referral to law enforcement, for any illegal or unauthorized use of the
        Service or the Site. <br /> <br />- Terminate or suspend your access to
        ...
        PARTIES OR LAW ENFORCEMENT AUTHORITIES. <br /> <br />
        ...
        activities described in this section. <br /> <br />
        VII. Indemnity
        <br />
        ...
        <br /> Rights Upsurge reserves all rights not specifically granted
        ...
        <br /> <br /> As between the parties, Upsurge owns and shall continue to
        ...
        IX. Copyright Protection <br /> The U.S. Digital Millennium Copyright
        ...
        <br /> <br /> X. Data Processing Addendum
        <br /> To the extent that Upsurge processes any personal data on your
        ...
        the parties agree to comply with such terms. <br /> <br />
        XI. Governing Law <br />
        ...
        Upsurge agrees to such governing state law. <br /> <br />
        XII.
        <br /> Disclaimer of Warranties THE MATERIALS, CONTENT ON THIS SITE AND
        ...
        ATTACKS, AND DENIAL OF SERVICE (DOS) ATTACKS. <br /> <br />
        ...
        <br /> <br /> UPSURGE’S AND ITS LICENSORS’ ENTIRE AND AGGREGATE
        ...
        <br />
        XIV. Entire Agreement; Modifications <br /> These Terms constitute the
        ...
        enforcement or interpretation of these Terms. <br /> <br />
        ...
        <br /> <br /> XVI. Dispute Resolution
        <br /> The state or federal courts sitting in San Francisco County,
        ...
        terms, Upsurge agrees to such state law requirements. <br /> <br />
        XVII. Questions and Comments
        <br /> If you have any questions regarding these Terms, please contact
        Upsurge by emailing privacy@Upsurge.com.
        <br /> <br /> XVIII. Notices <br /> All notices regarding these Terms
