...
import PlayStoreSvg from "../SVGcomponents/PlayStoreSvg";
import AppleStoreSvg from "../SVGcomponents/AppleStoreSvg";
              ...
              <div className={styles.flexright}>
                ...
                <div>
                  ...
                  <div className={styles.btnContainer}>
                    <a href={Download_Games_Data[item].playstore} target="_blank" rel="noreferrer" className={styles.button}>
                      <PlayStoreSvg />
                    </a>
                    <a href={Download_Games_Data[item].apple} target="_blank" rel="noreferrer" className={styles.button}>
                      <AppleStoreSvg />
                    </a>
                  </div>
