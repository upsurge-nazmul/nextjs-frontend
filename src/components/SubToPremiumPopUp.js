    ...
    <div className={styles.subToPremium}>
      ...
      <div className={styles.block}>
        <div
          ...
          onClick={() => setShowSubToPremium(false)}
        >
        ...
        <p>
          Upgrade today to premium and enjoy{" "}
        ...
        <div className={styles.section}>
          ...
          <div className={styles.sectionRight}>
            <div className={styles.sectionItem}>
              <img
                src={require("../assets/pricing/kq_red.png").default.src}
                alt="Education Games"
                className={styles.sectionItemImage}
              />
              20 Quests
            ...
            <div className={styles.sectionItem}>
              <img
                src={
                  require("../assets/pricing/upsurge_goodie.svg").default.src
                }
                alt="Education Games"
                className={styles.sectionItemImage}
              />
