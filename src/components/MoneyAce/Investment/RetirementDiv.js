...
export default function RetirementDiv({
  ...
  useEffect(() => {
    ...
    async function getdata() {
      let res = await MoneyAceApis.getRetirementFundRates();
  ...
  async function loadportfolio() {
    let res = await MoneyAceApis.getRetirementFundHoldings();
    if (res && res.data && res.data.success) {
  ...
  async function handlebuy() {
    ...
    let res = await MoneyAceApis.buyRetirementFund({ amount });
    if (res && res.data && res.data.success) {
