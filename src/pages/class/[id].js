      ...
      <div className={styles.contentWrapper}>
        ...
        <div className={styles.mainhead}>
          ...
          <div className={styles.right}>
            <p className={styles.questheading}>Saving for future goals</p>
        ...
        <div className={styles.maincontent}>
          <div className={styles.left}>
            <p className={styles.heading}>About the Course</p>
            ...
            <p className={styles.heading}>Course Content</p>
            ...
            <div className={styles.coursecontentwrapper}>
              {demodata.map((section, index) => (
                <CourseContent data={section} key={"section" + index} />
              ))}
            </div>
          </div>
          <div className={styles.right}>
            <div className={styles.buttonwrapper}>
              ...
              <div className={styles.startbutton}>Start course</div>
            </div>
            <div className={styles.details}>
