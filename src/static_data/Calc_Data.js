export const Calc_Data = {
  homeLoan: {
    ...
    icon: "https://imgcdn.upsurge.in/images/Untitled-design-10.png",
  },
  carLoan: {
    heading: "Car Loan",
    ...
    icon: "https://imgcdn.upsurge.in/images/sven-d-a4-S6-KUu-Leo-M-unsplash.jpg",
  },
  education: {
    ...
    icon: "https://imgcdn.upsurge.in/images/md-duran-1-Vq-HRwxc-CCw-unsplash.jpg",
  },
  // vacation: {
  ...
  //   icon: "https://imgcdn.upsurge.in/images/Untitled-design-8.png",
  // },
  sip: {
    ...
    relative: ["carLoan", "restaurant", "homeLoan"],
    icon: "https://imgcdn.upsurge.in/images/Untitled-design-9.png",
  },
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-66.png",
  //   },
  //   retirement: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-11.png",
  ...
  restaurant: {
    ...
    icon: "https://imgcdn.upsurge.in/images/Untitled-design-12.png",
  },
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-13.png",
  //   },
  // Insurance: {
  //   heading: "Insurance?",
  //   subheading:
  ...
  //   icon: "https://imgcdn.upsurge.in/images/Untitled-design-14.png",
  // },
  //   currency: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-15.png",
  //   },
  //   college: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-16.png",
  //   },
  //   costofraising: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-18.png",
  //   },
  //   unicorn: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-19.png",
  //   },
  //   angel: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-20.png",
  //   },
  //   standardofliving: {
  ...
  //     icon: "https://imgcdn.upsurge.in/images/Untitled-design-17.png",
